...
public:
    ...
    void setupUi(QWidget *uTeams)
    {
        ...
        label_pic = new QLabel(uTeams);
        label_pic->setObjectName(QString::fromUtf8("label_pic"));
        label_pic->setGeometry(QRect(580, 60, 561, 491));
    ...
    {
        uTeams->setWindowTitle(QApplication::translate("uTeams", "Form", nullptr));
        sortBox->setCurrentText(QString());
        label->setText(QApplication::translate("uTeams", "All teams", nullptr));
        label_2->setText(QApplication::translate("uTeams", "Sort by:", nullptr));
