...
""));
        ...
        BackgroundImageVolcano = new QLabel(mainPage);
        BackgroundImageVolcano->setObjectName(QString::fromUtf8("BackgroundImageVolcano"));
        BackgroundImageVolcano->setGeometry(QRect(-6, -48, 1279, 769));
        BackgroundImageVolcano->setStyleSheet(QString::fromUtf8(""));
        dfs = new QPushButton(mainPage);
        dfs->setObjectName(QString::fromUtf8("dfs"));
        dfs->setGeometry(QRect(330, 40, 261, 21));
        bfs = new QPushButton(mainPage);
        bfs->setObjectName(QString::fromUtf8("bfs"));
        bfs->setGeometry(QRect(620, 40, 261, 21));
        stackedWidget->addWidget(mainPage);
        BackgroundImageVolcano->raise();
        package1->raise();
        package2->raise();
        package3->raise();
        package4->raise();
...
"border-radius: 5px;"));
    ...
    void retranslateUi(QWidget *user)
    {
        ...
        label->setText(QCoreApplication::translate("user", "Start from Denver", nullptr));
        pushButton->setText(QCoreApplication::translate("user", "Select", nullptr));
        package2->setTitle(QString());
        label_2->setText(QCoreApplication::translate("user", "Custom trip (they pick city order)", nullptr));
        pushButton_2->setText(QCoreApplication::translate("user", "Select", nullptr));
        package3->setTitle(QString());
        label_3->setText(QCoreApplication::translate("user", "Visit all cities starting from Detroit", nullptr));
        pushButton_3->setText(QCoreApplication::translate("user", "Select", nullptr));
        package4->setTitle(QString());
        label_4->setText(QCoreApplication::translate("user", "Custom trip (we pick city order)", nullptr));
        pushButton_4->setText(QCoreApplication::translate("user", "Select", nullptr));
        BackgroundImageVolcano->setText(QString());
        dfs->setText(QCoreApplication::translate("user", "DFS Starting with Orlando Magic", nullptr));
        bfs->setText(QCoreApplication::translate("user", "BFS Starting with Los Angeles Lakers", nullptr));
        pushButtonGroup->setTitle(QString());
        travelPackButton->setText(QCoreApplication::translate("user", "Travel Options", nullptr));
        teamButton->setText(QCoreApplication::translate("user", "The Teams", nullptr));
        infoButton->setText(QCoreApplication::translate("user", "Team Info", nullptr));
        coachButton->setText(QCoreApplication::translate("user", "Coaches", nullptr));
        confrenceButton->setText(QCoreApplication::translate("user", "Confrences", nullptr));
        divisionButton->setText(QCoreApplication::translate("user", "Divisions", nullptr));
        arenaButton->setText(QCoreApplication::translate("user", "Arenas", nullptr));
        logoutButton->setText(QCoreApplication::translate("user", "LOGOUT", nullptr));
    } // retranslateUi
