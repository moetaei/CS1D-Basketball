...
public:
    ...
    {
        Option2->setWindowTitle(QCoreApplication::translate("Option2", "Form", nullptr));
        label->setText(QCoreApplication::translate("Option2", "Select Starting City", nullptr));
        confirm->setText(QCoreApplication::translate("Option2", "Confirm", nullptr));
    } // retranslateUi
