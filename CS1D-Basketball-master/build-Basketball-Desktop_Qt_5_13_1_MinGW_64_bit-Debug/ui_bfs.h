...
public:
    ...
    void retranslateUi(QWidget *bfs)
    {
        ...
        exit->setText(QCoreApplication::translate("bfs", "Exit", nullptr));
        label->setText(QCoreApplication::translate("bfs", "BFS starting with Los Angeles Lakers (shortest distance) ", nullptr));
    } // retranslateUi
