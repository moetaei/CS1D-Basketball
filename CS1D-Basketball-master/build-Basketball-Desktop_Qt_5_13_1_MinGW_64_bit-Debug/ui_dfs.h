...
public:
    ...
    void retranslateUi(QWidget *dfs)
    {
        ...
        label->setText(QCoreApplication::translate("dfs", "DFS starting with Orlando Magic (shortest distance) ", nullptr));
        exit->setText(QCoreApplication::translate("dfs", "Exit", nullptr));
    } // retranslateUi
